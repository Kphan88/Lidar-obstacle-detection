...

{
	...
	std::vector<int> nearests = tree->search(points[indice], distanceTol);
	...
	{
		if (!processed[id])
			proximityCluster(id, points,cluster, distanceTol, tree, processed);
	}
	...
	while( i< points.size())
		{
			...
			std::vector<int> cluster;
			proximityCluster(i, points,cluster, distanceTol, tree, processed);
			clusters.push_back(cluster);

			//std::cout<<"cluster size "<< cluster.size()<< std::endl;
			//std::cout<<"i "<< i<<"processed i: "<< processed[i]<< std::endl;				
			i++;
		}
